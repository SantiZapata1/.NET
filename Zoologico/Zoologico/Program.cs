...
namespace Zoologico
{
    ...
    class Program
    {
        ...
        public static void Main(string[] args)
        {
            ...
            do
            {
                ...
                {
                    case 1:
                        Console.WriteLine("Ha seleccionado la opción Agregar animal al zoo");
    ...
    class Zoo
    {
        ...
        public void agregarAnimal(Animal nuevoAnimal)
        {
            ...
            Console.WriteLine($"nuevo animal -{nuevoAnimal.nombre}- agregado al zoo");
        }
        ...
        {
            Console.WriteLine("- animales del zoo: ");
        ...
        {
            Console.WriteLine("- cuidadores del zoo: " );
